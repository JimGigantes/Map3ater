...
//This creates the 4 cards in the row
   for (var j = 0; j < 4; j++) {
	  ...
	  htmlRow.append('<div class="col s12 m6 l3"> <div class="card" id="card'+cardCount+'"> <div class="card-image"> <img src="https://flagcdn.com/256x192/'+list[k].country+'.png"> <span class="card-title1 white-text"> ' + "  " + list[cardCount].cuisine+ "  " + ' </span> <a href="" class="waves-effect waves-light btn-floating halfway-fab indigo modal-trigger pulse pink" href="#modal1" button data-target="modal1" class="btn modal-trigger"> <i class="material-icons" country-id=' + list[k].countryInitials + ' >favorite</i> </a></div> <div class="card-content indigo lighten-4"> </div> </div>');
     k++
     cardCount++
   }
//appends
