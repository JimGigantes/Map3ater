...
//   The Function to Start the Modal 
 ...
 function runTheCusine(cusineCode,countryCode){
                  ...
                  // Log the resulting object
                    ...
                    modalContent.append("<img src='https://flagcdn.com/32x24/" + countryCode  +".png' width='50'  height='50' id='icon'>")
                  ...
                  for (var i = 0 ; i < numberOfMeals; i++){
                     ...
                     modalContent.append("<img src="+response.meals[i].strMealThumb + " class='foodIcon' meal-Name='" + mealName + "' meal-ID='" + mealID + "' >")
                     modalContent.append("<a>" + response.meals[i].strMeal + "</a>")
